...
CREATE TABLE "new_Team" (
    ...
    "funds" INTEGER NOT NULL DEFAULT 5000000,
...
INSERT INTO "new_Team" ("countryId", "createdAt", "id", "name", "ownerId", "updatedAt", "value") SELECT "countryId", "createdAt", "id", "name", "ownerId", "updatedAt", "value" FROM "Team";
DROP TABLE "Team";
